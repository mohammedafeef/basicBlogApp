        ...
        <>
            <div className="container">
                <div className='row home_row'>
                    <div className='col-md-5 col-10 border-right-1 border-dark mx-auto'>
                        <div className="address text-uppercase justify-content-center align-center blog_summry h4">
                        mrunknown coperation LTD.<br/>
                        techno park 4rd block
                        puthanapalil (road), palarivadam<br/>
                        eranakulam (dist), india 
                        </div>
                    </div>
                    <div className='col-md-5 col-10 mx-auto'>
                        <div className='contact_form justify-content-center align-center '>
                            <div className="mb-3">
                            ...
                            <button type="button" className="btn btn-dark align-center p-2 rounded ml-1">
                                send
                            </button>
                            </div>
                        </div>
                    </div>
                    <div className='col-10 mx-auto d-flex justify-content-center mt-2 '>
                        <div className='social_link mx-2 p-2 rounded-circle'>
                        <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-bicycle link_icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className='social_link mx-2 p-2 rounded-circle'>
                        <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-archive-fill link_icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M12.643 15C13.979 15 15 13.845 15 12.5V5H1v7.5C1 13.845 2.021 15 3.357 15h9.286zM5.5 7a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5zM.8 1a.8.8 0 0 0-.8.8V3a.8.8 0 0 0 .8.8h14.4A.8.8 0 0 0 16 3V1.8a.8.8 0 0 0-.8-.8H.8z"/>
                        </svg>
                        </div>
                        <div className='social_link mx-2 p-2 rounded-circle'>
                        <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-controller link_icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className='social_link mx-2 p-2 rounded-circle'>
                        <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-align-bottom link_icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
